...
<div className="hero-btns" >
    <Buttons  className="btns" buttonStyle={'btn--outline'} buttonSize={'btn--large'}>
       <Link to="split-expense" className='q-split'  style={{ textDecoration: "none", color:"white" }}> <span className='q-split'>Quick Split</span> {console.log("res"  , data.loggedIn)}</Link>
    </Buttons>
